...
public class RandomHyperedgeSelector {
    private final static String DATA_FILE = "src/main/java/com/eventhypergraph/dataset/temporal-restricted/coauth-DBLP/hyperedge-id-unique.txt";

    private final static String OUTPUT_FILE = "src/main/java/com/eventhypergraph/experiment/ex1/coauth-DBLP-selectedEdges.txt";
