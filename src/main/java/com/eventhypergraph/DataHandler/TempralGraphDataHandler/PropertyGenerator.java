...
public class PropertyGenerator {
    // 节点标签文件
    private static final String NODE_LABELS = "src/main/java/com/eventhypergraph/dataset/temporal-restricted/coauth-DBLP/coauth-DBLP-node-labels.txt";

    private static final String NODE_PROPERTY = "src/main/java/com/eventhypergraph/dataset/temporal-restricted/coauth-DBLP/node-property";
